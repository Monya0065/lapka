...
const checks = [
  { email:'owner@lapka.local', route:'/owner/care', items:[['link','Открыть центр ухода'],['link','Паспорт питомца']] },
  { email:'owner@lapka.local', route:'/owner/services', items:[['link','Карта'],['link','Паспорт'],['link','Расходы']] },
  ...
  { email:'admin@lapka.local', route:'/clinic/inpatient', items:[['link','Расписание'],['link','Inbox'],['link','Реестр пациентов']] },
